...
@section('formcontent')
<form action="/insert" method="POST" class="col-md-7 p-3 border ">
                @csrf
                ...
                <div class="border-top border-bottom pb-3 pt-3">
                        ...
                        <button type="button" class="btn btn-Light">Infos</button>
                            ...
                            <button type="button" class="btn bg-danger">Thémes</button>
                        </div>
                ...
                <div class="form-group row"> 
                    <div class="col-md-12">
                        <label for="Secteur d'activité" class="col-form-label col-md-12">thémes:</label>
                        @foreach ($titles as $id => $title)
                        <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="theme[]" value="{{$id}}" >
