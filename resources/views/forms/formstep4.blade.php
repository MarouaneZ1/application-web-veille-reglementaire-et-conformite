...
@section('title',"step 3 sous branches")
@section('formcontent')
<form action="{{route('forms.selectactivitypost')}}" method="POST" class="col-md-7 p-3 border ">
                ...
                <div class="border-top border-bottom pb-3 pt-3">
                        ...
                        <div class="progress-bar bg-danger" role="progressbar" style="width: 59.1%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                </div>
                @if($status)
                            ...
                            <div id="flush-collapse<?=$i?>" class="accordion-collapse collapse" aria-labelledby="flush-heading<?=$i?>" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                            <div class="col-md-12">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" name="sousbranche[]" value="{{$id}}" >
