...
@section('title',"step 4 activity")
@section('formcontent')
<form action="{{route('forms.themepost')}}" method="POST" class="col-md-7 p-3 border ">
                ...
                <div class="border-top border-bottom pb-3 pt-3">
                        ...
                        <div class="progress-bar bg-danger" role="progressbar" style="width: 68.05%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                </div>
                @if($status)
                            ...
                            <div id="flush-collapse<?=$i?>" class="accordion-collapse collapse" aria-labelledby="flush-heading<?=$i?>" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                            <div class="col-md-12">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" name="activite[]" value="{{$id}}" >
                                                        <label class="form-check-label" for="{{$id}}">
                                                        {{$title}}
                                                        </label>
                                                    </div> 
                                                    @endforeach
                                                    @error('Secteurdactivite')<span style="color:red;">{{ $message }}</span>@enderror
                                            </div>
                                        </div> 
                                    </div>
                                </div>
