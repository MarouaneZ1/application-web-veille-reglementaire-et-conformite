...
@section('TR','active')
@section('text','show')
@section('Définitions','bg-danger')
@section('pagecontent')
<script>
    function getid(button){
    let idch=button.parentElement.parentElement;
    document.getElementById("contentu").innerText=idch.children[2].innerText;
    document.getElementById("avisu").innerText=idch.children[3].innerText;
    document.getElementById("referenceu").innerText=idch.children[4].innerText;
    document.getElementById("definition_id").value=idch.children[0].innerText;
    document.getElementById("nameu").value=idch.children[1].innerText;
                }
    function getid2(id){ 
    let idch=id.parentElement.parentElement;                  
    document.getElementById("formdelete").action="/dashboard/TexteReglementaire/deletedefinition/"+idch.children[0].innerText;}
</script> 
<!-- modal add -->
<div class="modal fade" id="addmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="/dashboard/TexteReglementaire/adddefinition"  method="POST" >
                @csrf
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <input name="name" id="name" type="text" class="form-style form-control @error('name') is-invalid @enderror" value="{{ old('name') }}">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="/dashboard/TexteReglementaire/updatedefinition"  method="POST" >
                @csrf
                <input type="number" id="definition_id" name="definitionid" style="display:none;">
                <div class="form-group row">
                    <div class="col-md-12">
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <input name="nameu" id="nameu" type="text" class="form-style form-control @error('nameu') is-invalid @enderror" value="{{ old('nameu') }}">
            ...
            <div class="row">
                <div class="col-md-12 mt-lg-4 mt-4">
                    <div class="d-sm-flex align-items-end justify-content-end mb-2">
                          <button data-toggle="modal" class="btn btn-primary" data-target="#addmodal"><i class="fas fa-plus-square pr-2 fa-lg"></i>Ajouter une définition</button>
      </div>
                    </div>
		        </div>
                    <!-- column -->
                    <div class="col-md-12 mt-4">
                        <div class="card">
                            <h5 class="card-header">Définitions</h5>
                            <div class="card-body">
                                <!-- title -->
