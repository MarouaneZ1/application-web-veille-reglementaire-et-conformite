...
@section('Régions','bg-danger')
@section('region','show')
@section('pagecontent')
<script>
function getid(button){
  let idch=button.parentElement.parentElement;
  document.getElementById("Nomu").value=idch.children[1].innerText;
document.getElementById("zoneu").value=idch.children[2].innerText;
 document.getElementById("id").value=idch.children[0].innerText;
              }
function getid2(id){ 
let idch=id.parentElement.parentElement;                  
document.getElementById("formdelete").action="/dashboard/territoire/region/delete/"+idch.children[0].innerText;}
 </script> 
<!-- modal add -->
<div class="modal fade" id="addmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="/dashboard/territoire/region/addregion/"  method="POST">
                @csrf
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <label for="zone" class="col-form-label col-md-5">ZONE:</label>
                        <input type="text" class="form-style form-control @error('zone') is-invalid @enderror" name="zone" value="{{ old('zone') }}" placeholder="zone...">
                        @error('zone')<span style="color:red;">{{ $message }}</span>@enderror
                    </div>
                </div>
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="/dashboard/territoire/region/update/"  method="POST">
                @csrf
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        @error('Nomu')<span style="color:red;">{{ $message }}</span>@enderror
                    </div>
                    <div class="col-md-6">
                        <label for="zoneu" class="col-form-label col-md-5">ZONE:</label>
                        <input type="text" class="form-style form-control @error('zoneu') is-invalid @enderror" id="zoneu" name="zoneu" value="{{ old('zoneu') }}" placeholder="zone...">
                        @error('zoneu')<span style="color:red;">{{ $message }}</span>@enderror
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 mt-lg-4 mt-4">
                    <div class="d-sm-flex align-items-end justify-content-end mb-2">
                          <button data-toggle="modal" class="btn btn-primary" data-target="#addmodal"><i class="fas fa-plus-square pr-2 fa-lg"></i>Ajouter une Région</button>
      </div>
                    </div>
		        </div>
                    <!-- column -->
                    <div class="col-md-12 mt-4">
                        <div class="card">
                            <h5 class="card-header">Régions</h5>
                            <div class="card-body">
                                <!-- title -->
