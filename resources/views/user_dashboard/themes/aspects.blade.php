...
document.getElementById("formdelete").action="/dashboard/themes/aspects/delete/"+idch.children[0].innerText;}
</script>
<!-- Modal -->
<!-- add modal -->
<div class="modal fade" id="addmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="/dashboard/themes/aspects/addaspect/"  method="POST">
                @csrf
                <div class="form-group row">
    
                    <div class="col-md-6">
                        <label for="name" class="col-form-label col-md">Nom de l'aspect:</label>
                        <input type="text" class="form-style form-control @error('namea') is-invalid @enderror" id="namea" name="namea"  value="{{ old('namea') }}" placeholder="name...">
                       
                    </div>
                   
                    <div class="col-md-6">
                        <label for="name" class="col-form-label col-md">Thème:</label>
                        <select class="form-control form-control-sm" id="example" name="n1aspecta"  aria-label="Default select example">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="/dashboard/themes/aspects/update/"  method="POST">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <label for="name" class="col-form-label col-md">Thème:</label>
                        <select class="form-control form-control-sm" id="example" name="n1aspect"  aria-label="Default select example">
                          @foreach($themes as $k=>$v)
                          <option  title="{{$v}}" value="{{$k}}">{{$v}}</option>
                          @endforeach
                        </select>
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Modifier Les Bulletins Officiels</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <div class="container-fluid px-lg-4">
            ...
            <div class="col-md-12 mt-lg-4 mt-4">
                    <div class="d-sm-flex align-items-end justify-content-end mb-2">
                          <button data-toggle="modal" class="btn btn-primary" data-target="#addmodal"><i class="fas fa-plus-square pr-2 fa-lg"></i>Ajouter un Aspect</button>
      </div>
                    </div>
		        </div>
                    <div class="col-md-12 mt-4">
                        <div class="card">
                            <h5 class="card-header">Aspects</h5>
                            <div class="card-body">
                                <!-- title -->
                                ...
                                <table id="table" class="table table-striped ">
                                    ...
                                    @foreach ($aspects as $aspect)
                                        <tr>
                                            <td> {{$aspect->id}} </td>
                                            <td>{{$aspect->name}}</td>
                                            <td>{{$aspect->themesname}}</td>
                                            <td>
                                            <a  data-toggle="modal"  id="updateaspect" class="badge badge-light edit" data-target="#editmodal" onclick='getid(this)' ><i class="fas fa-edit"></i></a>
