...
document.getElementById("formdelete").action="/dashboard/themes/theme/delete/"+idch.children[0].innerText;}
</script>
<!-- add Modal -->
<div class="modal fade" id="addmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="/dashboard/themes/theme/addtheme/"  method="POST">
                @csrf
                <div class="form-group row">
                    <div class="col-md-6">
                        <label for="namet" class="col-form-label col-md-5">Nom du theme:</label>
                        <input type="text" class="form-style form-control @error('namet') is-invalid @enderror" id="namet" name="namet"  value="{{ old('namet') }}" placeholder="name...">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="/dashboard/themes/theme/update/"  method="POST">
                @csrf
                <input type="text" style="display:none;" id="id" name="id"  value="{{ old('id') }}">
                <div class="form-group row">
                    <div class="col-md-6">
                        <label for="name" class="col-form-label col-md-5">Nom du theme:</label>
        ...
        <div class="container-fluid px-lg-4">
            ...
            <div class="col-md-12 mt-lg-4 mt-4">
                    <div class="d-sm-flex align-items-end justify-content-end mb-2">
                          <button data-toggle="modal" class="btn btn-primary" data-target="#addmodal"><i class="fas fa-plus-square pr-2 fa-lg"></i>Ajouter un Theme</button>
      </div>
                    </div>
		        </div>
                                ...
                                <table id="table" class="table table-striped ">
                                    ...
                                    @foreach ($themes as $theme)
                                        <tr>
                                            ...
                                            <td>{{$theme->name}}</td>
                                            <td>
                                            <a  data-toggle="modal"  id="updatetheme" class="badge badge-light edit" data-target="#editmodal" onclick='getid(this)'><i class="fas fa-edit"></i></a>
