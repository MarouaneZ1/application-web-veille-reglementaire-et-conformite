...
function getid2(id){ 
                ...
                document.getElementById("formdelete").action="/dashboard/secteursdactivites/branche/delete/"+idch.children[0].innerText;}
</script>
...
<div class="modal fade" id="addmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="/dashboard/secteursdactivites/branche/addbranche/"  method="POST">
                @csrf
                <div class="form-group row">
                    <div class="col-md">
                        <label for="Nameb" class="col-form-label col-md-5">Name:</label>
                        <input type="text" class="form-style form-control @error('Nameb') is-invalid @enderror" id="Nameb" name="Nameb"  value="{{ old('Nameb') }}" placeholder="Name...">
                        
                    </div></div>
                <div class="form-group row">
                    <div class="col-md">
                        <label for="Codeb" class="col-form-label col-md-5">Code:</label>
                        <input type="text" class="form-style form-control @error('Codeb') is-invalid @enderror" id="Codeb" name="Codeb" value="{{ old('Codeb') }}" placeholder="Code...">
                        
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md">
                        <label for="Nsectionb" class="col-form-label col-md-5">section:</label>
                        <select class="form-control form-control-sm" id="example" name="Nsectionb"  aria-label="Default select example">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="/dashboard/secteursdactivites/branche/update/" method="POST">
                @csrf
        ...
        <div class="container-fluid px-lg-4">
            ...
            <div class="col-md-12 mt-lg-4 mt-4">
                    <div class="d-sm-flex align-items-end justify-content-end mb-2">
                          <button data-toggle="modal" class="btn btn-primary" data-target="#addmodal"><i class="fas fa-plus-square pr-2 fa-lg"></i>Ajouter une Branche</button>
                  </div>
                                </div>
                        </div>
                                ...
                                <table id="table" class="table table-striped">
                                    ...
                                    @foreach ($branches as $branche)
                                        <tr>
                                            ...
                                            <td>{{$branche->code}}</td>
                                            <td>{{$branche->name}}</td>
                                            <td>{{$branche->sectionname}}</td>
                                            <td>
                                            <a  data-toggle="modal" id="updatebranche" class="badge badge-light edit" data-target="#editmodal" onclick="getid(this)"><i class="fas fa-edit"></i></a>
